...
int main() {
    ...
    // cout << bst.search(4, bst.root) << endl;
    // cout << bst.root << endl;
    // bst.recursion_insert(4, bst.root);
    // cout << bst.search(4, bst.root) << endl;
    // cout << bst.Max(bst.root) << endl;
    // bst.delete_nlr(bst.root);
    // cout << bst.search(2, bst.root) << endl;



    //unique_ptr<int[]> ptr = make_unique<int[]>([](int n){});
